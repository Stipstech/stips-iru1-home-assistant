...
CONF_DEVICE_IPS = "device_ips"
CONF_AUTO_UPDATE_IP = "auto_update_ip"

SERVER_PRODUCTION = "production"
SERVER_STAGING = "staging"
PRODUCTION_API_HOST = "production.api.stips.visionalization.net"
STAGING_API_HOST = "stips.api.stagging.visionalization.net"
API_HOSTS = {
    SERVER_PRODUCTION: PRODUCTION_API_HOST,
    SERVER_STAGING: STAGING_API_HOST,
}
DEFAULT_SERVER = SERVER_PRODUCTION
